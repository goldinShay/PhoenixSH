...
import sensors.*;
import storage.xlc.XlSenseControlManager;
...
class XlSenseControlManagerTest {
    ...
    void testAppendToSenseControlSheet() {
        ...
        boolean result = XlSenseControlManager.appendToSenseControlSheet(light, sensor);
    ...
    void testUpdateAutoOpThresholds() {
        ...
        boolean updated = XlSenseControlManager.updateAutoOpThresholds("LI777", 1600.0, 999.0);
