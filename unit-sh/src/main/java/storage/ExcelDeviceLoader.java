        ...
        try (InputStream fis = new FileInputStream(filePath);
            ...
            for (Row row : sheet) {
                ...
                try {
                    ...
                    String rawId = getCellValue(row, 1);
                    String normalizedId = rawId != null ? rawId.trim().toUpperCase() : "UNKNOWN";

                    device.setId(normalizedId);
                    ...
                    System.out.println("👀 Reading device ID: " + normalizedId + " (" + type + ")");
                    devices.put(normalizedId, device); // 🔐 Store with normalized ID
